...
const SHORTCUTS: { key: ViewKey; label: string; icon: React.ComponentType<{ className?: string }>; shortcut: string }[] = [
  ...
  { key: "jobs", label: "Jobs & ingest", icon: ListChecks, shortcut: "g j" },
  { key: "pipeline", label: "Live Pipeline", icon: Play, shortcut: "g p" },
  { key: "units", label: "Annotated Events", icon: TableProperties, shortcut: "g u" },
  ...
  { key: "taxonomy", label: "Risk taxonomy", icon: BookOpen, shortcut: "g t" },
        ...
        <div className="space-y-3">
          <div className="space-y-1.5">
            ...
            {[
              ...
              { keys: ["g", "t"], action: "Go to Risk taxonomy" },
